            ...
            <div class="col-md-6">
              ...
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Edit Data Pegawai <?php echo $data['username']; ?></h3>
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="level">
                        ...
                        ?>
                          <option class="bg-dark" value="<?php echo $row['id_petugas']; ?>" <?php if ($row['id_petugas'] == "$idpetugasyangdipilih") { ?> selected="selected" <?php } ?>><?php echo $row['level']; ?></option>
                        <?php
