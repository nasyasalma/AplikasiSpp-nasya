                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-warning" href="edit_petugas.php?id=<?php echo $row['id_petugas']; ?>">Edit</a>
                            <a class="btn btn-danger" href="proses_hapuspetugas.php?id=<?php echo $row['id_petugas']; ?>" onClick="return confirm('Anda yakin akan menghapus data ini?')">Hapus</a>
                          </td>
                        </tr>
