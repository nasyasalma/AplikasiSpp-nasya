                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-warning" href="edit_kelas.php?id=<?php echo $row['id_kelas']; ?>">Edit</a>
                            <a class="btn btn-danger" href="proses_hapuskelas.php?id=<?php echo $row['id_kelas']; ?>" onClick="return confirm('Anda yakin akan menghapus data ini?')">Hapus</a>
                          </td>
                        </tr>
