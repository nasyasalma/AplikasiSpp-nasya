                                ...
                                <form method="POST" action="ekspor.php" enctype="multipart/form-data">
                                    <section class="base">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="daritanggal" autofocus="" required="" />
                                        </div>
                                        <div class="form-group">
                                            <label>Sampai Tanggal</label>
                                            <input type="date" class="form-control" name="sampaitanggal" required="" />
                                        </div>
                                        <div>
                                            <button type="submit" class="btn btn-block btn-primary btn-sm">Lihat Data</button>
                                        </div>
                                    </section>
                                </form>
                            </div>
