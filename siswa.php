                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-warning" href="edit_siswa.php?id=<?php echo $row['nisn']; ?>">Edit</a>
                            <a class="btn btn-danger" href="proses_hapussiswa.php?id=<?php echo $row['nisn']; ?>" onClick="return confirm('Anda yakin akan menghapus data ini?')">Hapus</a>
                          </td>
                        </tr>
